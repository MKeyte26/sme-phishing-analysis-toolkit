...
### 3. Social Engineering Techniques
  |Impersonation (brand/person):| Enter Response:|
  |-----------------------------|----------------|
  |Urgency (“act now”):         |             
  |Fear / consequence:          |
...
### 5. URL Analysis
  |Extracted URLs [DEFANGED (CyberChef)]:| Enter Response:|
  |--------------------------------------|----------------|
  |Root Domain:|
...
|Classification (Phishing / Malicious / Suspicious / Benign etc): | Enter Response:|
|-----------------------------------------------------------------|----------------|
